//Exercise 9:  from  http://reactivex.io/learnrx/ 
...
//in order to apply filter() and map() operations on them. 
//In this section we'll define a concatAll() function that we can combine with map() and filter() to query trees.
